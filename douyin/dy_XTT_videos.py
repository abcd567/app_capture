...
try:
    ...
    android.view.ViewGroup/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout[2]/android.view.View')):
        ...
        driver.find_element_by_xpath('/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/\
        android.widget.FrameLayout[1]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.view.ViewGroup/\
        android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout[2]/\
        android.view.View').send_keys(douyin_id)
except:
    pass
...
try:
    ...
    android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.FrameLayout/\
    android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/\
    android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.HorizontalScrollView/android.widget.FrameLayout/\
    android.widget.LinearLayout/android.widget.RelativeLayout[1]/android.widget.TextView')):
        # 提取作品数量
        text = driver.find_element_by_xpath('/hierarchy/android.widget.FrameLayout/\
        com.bytedance.ies.dmt.ui.sliding.DmtSlidingPaneLayout/android.widget.LinearLayout/android.widget.FrameLayout/\
        android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.HorizontalScrollView/\
        android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.FrameLayout/\
        android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/\
        android.view.ViewGroup/android.widget.FrameLayout[2]/android.widget.HorizontalScrollView/android.widget.FrameLayout/\
        android.widget.LinearLayout/android.widget.RelativeLayout[1]/android.widget.TextView').text
        num = int(re.match('作品 (\d+)', text).group(1))
        # 点击第一个视频
        if num:
            if WebDriverWait(driver, 10).until(lambda x: x.find_element_by_xpath(
                    '//android.widget.ImageView[@content-desc="视频1"]')):
                driver.find_element_by_xpath('//android.widget.ImageView[@content-desc="视频1"]').click()
        # 等待进入页面后下拉
        if WebDriverWait(driver, 30).until(lambda x: x.find_element_by_id("com.ss.android.ugc.aweme:id/mu")):
            x, y = get_size(driver)
            x1 = int(x * 0.48)
            y1 = int(y * 0.90)
            y2 = int(y * 0.15)
